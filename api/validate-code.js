...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // MASTER CODE BYPASS — never expires, never gets marked used
    if (fields['Is Master'] === true) {
      return res.status(200).json({ valid: true, recordId });
    }
